<%@ Page Language="C#" MasterPageFile="~/SmartOffice.Master" AutoEventWireup="true" CodeBehind="ApprovalRequest.aspx.cs" Inherits="SmOffice.Views.ApprovalRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    <div style="height: 40px;">
        <asp:Label ID="lblTitleApprovalRequests" runat="server" style="color: #069;font-size:28px;font-weight:bold" Text="Approval Requests"></asp:Label>
        </div>
        ...
        <tr>
            ...
            <td>
                <asp:Repeater ID="RepeaterOvertimeUnread" runat="server">
                    ...
                    <ItemTemplate>
                    <li><a href='Outputs/OvertimeUnread?OAppId=<%# Eval("OAppId") %>.aspx'><%#Eval("OAppTime") %></a></li>
                    </ItemTemplate>
                    <FooterTemplate>
                    </ul>
                    </FooterTemplate>
        ...
        <tr>
            ...
            <td>
                <asp:Repeater ID="RepeaterReportUnread" runat="server">
                    ...
                    <ItemTemplate>
                    <li><a href='Outputs/ReportUnread?LogId=<%# Eval("LogId") %>.aspx'><%#Eval("LogTime") %></a></li>
                    </ItemTemplate>
                    <FooterTemplate>
                    </ul>
                    </FooterTemplate>
        ...
        <tr>
            ...
            <td>
                <asp:Repeater ID="RepeaterBorrowItemsUnread" runat="server">
                    ...
                    <ItemTemplate>
                    <li><a href='Outputs/BorrowItemsUnread?BAppId=<%# Eval("BAppId") %>.aspx'><%#Eval("BAppTime") %></a></li>
                    </ItemTemplate>
                    <FooterTemplate>
                    </ul>
                    </FooterTemplate>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:Repeater ID="RepeaterContractRead" runat="server">
                    ...
                    <ItemTemplate>
                    <li><a href='Outputs/ContractRead.aspx?CAppId=<%# Eval("CAppId") %>.aspx' target="_blank"><%#Eval("CAppTime") %></a></li>
                    </ItemTemplate>
                    <FooterTemplate>
                    </ul>
                    </FooterTemplate>
            ...
            <td>
                <asp:Repeater ID="RepeaterContractUnread" runat="server">
                    ...
                    <ItemTemplate>
                    <li><a href='Outputs/ContractUnread?CAppId=<%# Eval("CAppId") %>.aspx'><%#Eval("CAppTime") %></a></li>
                    </ItemTemplate>
                    <FooterTemplate>
                    </ul>
                    </FooterTemplate>
        ...
        <tr>
            ...
            <td>
                <asp:Repeater ID="RepeaterPaidTimeOffUnread" runat="server">
                    ...
                    <ItemTemplate>
                    <li><a href='Outputs/PaidTimeOffUnread?LAppId=<%# Eval("LAppId") %>.aspx'><%#Eval("LAppTime") %></a></li>
                    </ItemTemplate>
                    <FooterTemplate>
                    </ul>
                    </FooterTemplate>
        ...
        <tr>
            ...
            <td>
                <asp:Repeater ID="RepeaterReimbursementUnread" runat="server">
                    ...
                    <ItemTemplate>
                    <li><a href='Outputs/ReimbursementUnread?RAppId=<%# Eval("RAppId") %>.aspx'><%#Eval("RAppTime") %></a></li>
                    </ItemTemplate>
                    <FooterTemplate>
                    </ul>
                    </FooterTemplate>

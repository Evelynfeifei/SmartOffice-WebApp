<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BorrowItemsUnreadS.aspx.cs" Inherits="SmOffice.Views.Outputs.BorrowItemsUnreadS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    ...
    <table align="center"; style="width: 1024px;height:300px" margin: auto; border: 5px solid white">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblDetailsS" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 250px">
